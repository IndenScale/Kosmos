...
declare -A SERVICES=(
    ...
    ["assessment_scheduler"]="./scripts/run_assessment_dramatiq_default.sh"
    ["assessment_dramatiq_default"]="./scripts/run_assessment_dramatiq_default.sh"
    ["assessment_dramatiq_agents"]="./scripts/run_assessment_dramatiq_agents.sh"
